                ...
                <form action="{{route('product.store')}}" class="form"  method="POST">
                   ...
                   <div class="row">
                       <div class="form-group col-6">
                           ...
                           <input type="number" name="imei_1" id="qr" wire:model="imei_2" placeholder="imei raqamini kiriting" class="form-control">
                       </div>
                       <div class="form-group col-6">
                           <label for="qr2">Uz Imei 2</label>
                           <input type="number" name="imei_2" id="qr2" wire:model="imei_1" placeholder="imei raqamini kiriting" class="form-control">
                       </div>
                   </div>
                    <div class="row">
                        <div class="form-group col-6">
